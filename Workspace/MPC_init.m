...
scenario = course1_lancechange;                     %This represents function from Drive scenerio lane change.
% scenario = course2_fig8;                     %This represents function from Drive scenerio fig eight course.
% scenario = course3_city_road;                     %This represents function from Drive scenerio city road
n = size(scenario);
